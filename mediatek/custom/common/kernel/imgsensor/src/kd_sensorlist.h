...
//UINT32 OV5648MIPISUNNYSensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(OV5648_MIPI_RAW_SUNNY)
    //{OV5648MIPISUNNY_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_SUNNY, OV5648MIPISUNNYSensorInit}, 
#endif
