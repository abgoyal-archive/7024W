...
refine_CCM(RAWIspCamInfo const& rCamInfo, IspNvramRegMgr const& rIspRegMgr, ISP_NVRAM_CCM_T& rCCM)
{
	...
	//					 THH2  TH2	THL2				   THH1  TH1  THL1
	   ...
	   {
			 case eIDX_Shading_CCT_ALight:
			 rCCM.conv0a.val=0x07CC0197;
			 rCCM.conv0b.val=0x0000079D;
			 rCCM.conv1a.val=0x017B07AC;
			 rCCM.conv1b.val=0x000007D9;
			 rCCM.conv2a.val=0x072B0002;
			 rCCM.conv2b.val=0x000001D3;
			 break;
			 case eIDX_Shading_CCT_CWF:
			 rCCM.conv0a.val=0x07520223;
			 rCCM.conv0b.val=0x0000078B;
			 rCCM.conv1a.val=0x017E079E;
			 rCCM.conv1b.val=0x000007E4;
			 rCCM.conv2a.val=0x07760000;
			 rCCM.conv2b.val=0x0000018A;
			 break;
			 case eIDX_Shading_CCT_D65:
...
#else
			  rCCM.conv0a.val=0x079901BA;
			  rCCM.conv0b.val=0x000007AD;
			  rCCM.conv1a.val=0x017807B7;
			  rCCM.conv1b.val=0x000007D1;
			  rCCM.conv2a.val=0x07810000;
			  rCCM.conv2b.val=0x0000017F;
#endif
			 break;
