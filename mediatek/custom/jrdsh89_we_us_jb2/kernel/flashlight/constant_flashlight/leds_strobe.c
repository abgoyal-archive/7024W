...
#define GPIO_TORCH_FLASH GPIO157
#define PWM_FLASH_EN GPIO265
#define PWM_GPIO GPIO73
...
PK_DBG("called------------\n");					
	mt_set_gpio_out(GPIO_TORCH_FLASH, GPIO_OUT_ONE);
	mt_set_gpio_out(PWM_FLASH_EN, GPIO_OUT_ONE);
	upmu_set_rg_bst_drv_1m_ck_pdn(0);
	upmu_set_flash_en(1);
	mt_set_gpio_mode(PWM_GPIO, GPIO_MODE_00);
   	mt_set_gpio_dir(PWM_GPIO, GPIO_DIR_OUT);
    	mt_set_gpio_out(PWM_GPIO, GPIO_OUT_ONE);
...
{
PK_DBG("called------------\n");			
	mt_set_gpio_out(GPIO_TORCH_FLASH, GPIO_OUT_ZERO);
	mt_set_gpio_out(PWM_FLASH_EN, GPIO_OUT_ZERO);
	upmu_set_flash_en(0);

	mt_set_gpio_mode(PWM_GPIO, GPIO_MODE_00);
	mt_set_gpio_dir(PWM_GPIO, GPIO_DIR_OUT);
    	mt_set_gpio_out(PWM_GPIO, GPIO_OUT_ZERO);
...
{
PK_DBG("called------------\n");			
	mt_set_gpio_mode(GPIO_TORCH_FLASH, GPIO_MODE_00);
    	mt_set_gpio_dir(GPIO_TORCH_FLASH, GPIO_DIR_OUT);
    	mt_set_gpio_mode(PWM_FLASH_EN, GPIO_MODE_00);
    	mt_set_gpio_dir(PWM_FLASH_EN, GPIO_DIR_OUT);
    	mt_set_gpio_out(GPIO_TORCH_FLASH, GPIO_OUT_ZERO);
...
ssize_t TORCH_select(void)
{
	...
	upmu_set_rg_bst_drv_1m_ck_pdn(0);
	upmu_set_flash_en(1);
	mt_set_gpio_mode(PWM_GPIO, GPIO_MODE_01);
