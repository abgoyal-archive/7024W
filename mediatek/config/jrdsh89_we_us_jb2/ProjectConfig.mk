...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME=MTK_CNAP_SUPPORT MTK_WIFI_CALLING_RIL_SUPPORT MTK_ACMT_DEBUG MTK_BT_PROFILE_AVRCP MTK_MMPROFILE_SUPPORT MTK_GPS_SUPPORT MTK_MULTIBRIDGE_SUPPORT EVDO_DT_SUPPORT MTK_CAMCORDER_PROFILE_MID_MP4 MTK_FM_SUPPORT MTK_USES_HD_VIDEO MTK_TABLET_PLATFORM MTK_DUAL_MIC_SUPPORT MTK_AUTO_DETECT_MAGNETOMETER MTK_AUDIO_ADPCM_SUPPORT CUSTOM_KERNEL_OFN MTK_BT_PROFILE_MANAGER MTK_ION_SUPPORT MTK_TVOUT_SUPPORT MTK_FM_RECORDING_SUPPORT MTK_DEDICATEDAPN_SUPPORT MTK_DDR3_SUPPORT MTK_LCA_SUPPORT MTK_AUD_LOCK_MD_SLEEP_SUPPORT MTK_IPV6_SUPPORT MTK_DT_SUPPORT MTK_STEREO3D_WALLPAPER_APP MTK_BT_FM_OVER_BT_VIA_CONTROLLER MTK_BT_PROFILE_PBAP MTK_NFC_SUPPORT MTK_BT_PROFILE_A2DP MTK_BT_PROFILE_HFP MTK_BT_PROFILE_AVRCP14 MTK_VOICE_UI_SUPPORT MTK_MASS_STORAGE MTK_BICR_SUPPORT MTK_FM_50KHZ_SUPPORT MTK_BT_PROFILE_BPP MTK_COMBO_QUICK_SLEEP_SUPPORT MTK_THEMEMANAGER_APP MTK_HDR_SUPPORT MTK_TMP103_SUPPORT MTK_DSPIRDBG MTK_MT8193_SUPPORT MTK_MERGE_INTERFACE_SUPPORT HAVE_AACENCODE_FEATURE MTK_BT_PROFILE_MAPS MTK_BT_PROFILE_BIP MTK_WIFI_HOTSPOT_SUPPORT MTK_TB_DEBUG_SUPPORT MTK_COMBO_SUPPORT MTK_BT_PROFILE_OPP MTK_FLIGHT_MODE_POWER_OFF_MD MTK_RADIOOFF_POWER_OFF_MD MTK_PRECAPTURE_AF_SUPPORT MTK_BT_PROFILE_MAPC MTK_SHARED_SDCARD MTK_EMMC_DISCARD MTK_2IN1_SPK_SUPPORT MTK_EAP_SIM_AKA MTK_MULTI_STORAGE_SUPPORT MTK_MT8193_HDCP_SUPPORT MTK_ENABLE_VIDEO_EDITOR EVDO_DT_VIA_SUPPORT MTK_WFD_SUPPORT MTK_AUDIO_RAW_SUPPORT MTK_MAV_SUPPORT MTK_WAPI_SUPPORT MTK_FD_SUPPORT MTK_DISPLAY_HIGH_RESOLUTION HAVE_ADPCMENCODE_FEATURE MTK_TABLET_DRAM MODEM_UMTS_TDD128_MODE MTK_FACEBEAUTY_SUPPORT MTK_AAL_SUPPORT MTK_BQ24156_SUPPORT MTK_BT_SUPPORT MTK_BT_40_SUPPORT MTK_BT_PROFILE_FTP MTK_ASF_PLAYBACK_SUPPORT MTK_CAMERA_BSP_SUPPORT MTK_SPM_MCDI_ENABLE MTK_MT8193_HDMI_SUPPORT MTK_HIGH_QUALITY_THUMBNAIL MTK_IPV6_TETHER_NDP_MODE MTK_FM_RX_SUPPORT MTK_IMAGE_LARGE_MEM_LIMIT MTK_FM_TX_SUPPORT MTK_BRAZIL_CUSTOMIZATION_VIVO MTK_BRAZIL_CUSTOMIZATION_CLARO MTK_ENABLE_MD2 MTK_ENABLE_MD1 HAVE_XLOG_FEATURE MTK_RMVB_PLAYBACK_SUPPORT MTK_BT_PROFILE_SIMAP MTK_BT_PROFILE_TIMES MTK_NATIVE_3D_SUPPORT MTK_AUTORAMA_SUPPORT MTK_BT_PROFILE_TIMEC MTK_VOICE_UNLOCK_SUPPORT PLATFORM_VERSION_V4_2_2 MTK_TETHERING_EEM_SUPPORT MTK_MATV_ANALOG_SUPPORT MTK_BSP_PACKAGE MTK_SIM_AUTHENTICATION_SUPPORT MTK_BRAZIL_CUSTOMIZATION CUSTOM_KERNEL_ACCELEROMETER MTK_BEAM_PLUS_SUPPORT MTK_VT3G324M_SUPPORT MTK_TRIPLE_FRAMEBUFFER_SUPPORT MTK_CTA_SUPPORT MTK_KERNEL_POWER_OFF_CHARGING MTK_NAND_UBIFS_SUPPORT CUSTOM_KERNEL_GYROSCOPE MTK_NVRAM_SECURITY CUSTOM_KERNEL_MAGNETOMETER MTK_EMULATOR_SUPPORT MTK_BT_PROFILE_HIDH MTK_BT_PROFILE_PAN MTK_PRODUCT_INFO_SUPPORT MTK_CAMERA_APP_3DHW_SUPPORT MTK_WLAN_SUPPORT MTK_PQ_SUPPORT MTK_TETHERINGIPV6_SUPPORT MTK_IPOH_SUPPORT MTK_AUTO_DETECT_ACCELEROMETER HAVE_CMMB_FEATURE MTK_USES_VR_DYNAMIC_QUALITY_MECHANISM MTK_EMMC_SUPPORT_OTP MTK_TB_APP_CALL_FORCE_SPEAKER_ON MTK_COMBO_CORE_DUMP_SUPPORT MTK_TB_HW_DEBUG MTK_PLATFORM_OPTIMIZE MTK_2SDCARD_SWAP MTK_QVGA_LANDSCAPE_SUPPORT MTK_FM_SHORT_ANTENNA_SUPPORT MTK_HDMI_SUPPORT MTK_RILD_READ_IMSI MTK_BT_PROFILE_SPP MTK_BT_30_SUPPORT MTK_FAN5405_SUPPORT MTK_MT8193_NFI_SUPPORT MTK_HW_ENHANCE MTK_NCP1851_SUPPORT MTK_LCEEFT_SUPPORT MTK_BT_PROFILE_DUN MTK_DHCPV6C_WIFI MTK_BT_PROFILE_PRXM MTK_FSCK_MSDOS_MTK MTK_BATLOWV_NO_PANEL_ON_EARLY HAVE_AWBENCODE_FEATURE MTK_BQ24196_SUPPORT MTK_WEB_NOTIFICATION_SUPPORT MTK_MD_SHUT_DOWN_NT MTK_SPH_EHN_CTRL_SUPPORT MTK_WB_SPEECH_SUPPORT CUSTOM_KERNEL_ALSPS MTK_FORCE_CPU_89T MTK_BT_PROFILE_PRXR ENCRY_PARTITION_SUPPORT MTK_BQ27541_SUPPORT MTK_SD_REINIT_SUPPORT MTK_SENSOR_SUPPORT MTK_M4U_SUPPORT MTK_EMMC_SUPPORT MTK_BT_21_SUPPORT MTK_S3D_SUPPORT MTK_WLANBT_SINGLEANT
...
# Decide whether to build modem or not.
BUILD_MODEM=yes
...
CUSTOM_HAL_IMGSENSOR = ov5648_mipi_raw ov5648_mipi_raw_sunny gc0329_yuv
CUSTOM_HAL_LENS = dummy_lens dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov5648_mipi_raw_sunny
...
CUSTOM_KERNEL_IMGSENSOR = ov5648_mipi_raw ov5648_mipi_raw_sunny gc0329_yuv
CUSTOM_KERNEL_KPD=kpd
CUSTOM_KERNEL_LCM =nt35516_qhd_dsi_vedio nt35517_qhd_dsi_vedio otm9605a_dsi_vdo
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = ov5648_mipi_raw_sunny
...
CUSTOM_KERNEL_TOUCHPANEL=GT9XX ft6x06#cy8ctma300 GT818B-fpga
CUSTOM_KERNEL_USB=mt6577

# Support custom to set Vibrator timer.
CUSTOM_KERNEL_VIBRATOR=vibrator
CUSTOM_LK_LCM =nt35516_qhd_dsi_vedio nt35517_qhd_dsi_vedio otm9605a_dsi_vdo
CUSTOM_MODEM=jrdsh89_we_us_jb2_md1_hspa
...
CUSTOM_UBOOT_LCM = nt35516_qhd_dsi_vedio nt35517_qhd_dsi_vedio otm9605a_dsi_vdo
...
# open CMAS function in RAV4-TMO not need ETWS changed in 2013/05/23
MTK_ETWS_SUPPORT=no
...
# MTK_FLIGHT_MODE_POWER_OFF_MD is used to control if modem is powered off when entering flight mode MTK_TELEPHONY_MODE is used for specify current telephony mode MTK_FIRST_MD is used to specify the high priority modem
#Begin: modified by ktu for WFC on 20130520, because when handset is in airplane mode, still access GBA simcard to register TMO P-CSCF server.
MTK_FLIGHT_MODE_POWER_OFF_MD=no 
#End: modified by ktu for WFC on 20130520,because when handset is in airplane mode, still access GBA simcard to register TMO P-CSCF server.
...
MTK_SPECIFIC_SM_CAUSE=yes //PR467663,xfguo modify
...
JRD_IPHONE_HDST_COMPAT = yes
#Begin: added by ktu for WFC on 20130520
IMSPHONE = yes
#End: added by ktu for WFC on 20130520
#Begin: added by ktu for WFC on 20130621
MTK_WIFI_CALLING_RIL_SUPPORT = yes
#End: added by ktu for WFC on 20130621
